...
func TestReceiptTagsUpdate(t *testing.T) {
	...
	receipt, err := stores.Receipts.Create(ctx, entityID, "tag-test", "image/png", "uploaded", "receipt", "tag.png", 12, 0)
	if err != nil {
	...
	body, _ := json.Marshal(map[string]interface{}{
		"tags": []string{"Meals", "Client"},
	})
	req := httptest.NewRequest(http.MethodPatch, "/receipts/"+receipt.ID+"/tags", bytes.NewReader(body))
